...
function Character() {
 // Properties.
 this.image = new Image(); this.image.src = "Imagenes/macri.png";
 ...
 this.update = function () {
  if (keyboard.getPressed() == ' ') {
   this.image.src = "Imagenes/macri.png";
...
function Kamehameha() {
 // Properties.
 this.image = new Image(); this.image.src = "Imagenes/gato2.png";
...
function Minicell() {
 // Properties.
 this.image = new Image(); this.image.src = "Imagenes/cristina.png";
...
function Shot() {
 // Properties.
 this.image = new Image(); this.image.src = "Imagenes/dolar3.png";
...
var world = new Image(); world.src = "Imagenes/fondo.png";
...
bso.volume = 0.5;
bso.play();
var sonidoDisparoMacri = document.getElementById('disparoMacri');
var sonidoDisparoCristina = document.getElementById('disparoCristina');
